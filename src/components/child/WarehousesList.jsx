...
const WarehousesList = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if(canSubmit)
    {
      ...
      {
        fetch('https://backend-55jj.onrender.com/add_warehouse_values', { 
          method: 'POST', 
        ...
        {
            fetch('https://backend-55jj.onrender.com/update_warehouse_setup', { 
              method: 'POST', 
              headers:{   'Accept': 'application/json',
                'Content-Type': 'application/json'  },
  ...
  useEffect(() => {
    ...
    if (username) {
      ...
      $(document).off('click', '.ware_delete').on("click", '.ware_delete', function(e){
          e.preventDefault();
          var row_id = $(this).attr("data-lable");
          fetch('https://backend-55jj.onrender.com/warehouse_delete/'+row_id+'/'+localStorage.getItem('id'), { 
          method: 'DELETE', 
          headers:{   'Accept': 'application/json',
                    'Content-Type': 'application/json'  }, 
          body: JSON.stringify()
