...
const ManageQuoteList = () => {
  ...
  function refreshtable()
  {
    ...
    fetch('https://backend-55jj.onrender.com/quote_invoice_data'+'/'+localStorage.getItem('id')).then((res) =>
    ...
    if (username) {
      $(document).off('click', '.quote_view').on("click", '.quote_view', function(e){
        ...
        $('#tbl_view_order tbody').empty();
          var row_id = $(this).attr("data-lable");
          fetch('https://backend-55jj.onrender.com/get_quote_invoice_data', { 
            method: 'POST', 
      ...
      $(document).off('click', '.quote_delete').on("click", '.quote_delete', function(e){
        ...
        var row_id = $(this).attr("data-lable");
        setId(row_id);
        fetch('https://backend-55jj.onrender.com/quote_inv_delete/'+row_id+'/'+localStorage.getItem('id'), { 
          method: 'DELETE', 
    ...
    const handleSubmit = (e) => {
      ...
      if(canSubmit)
      {
        if($("#btnordersubmit").text().trim() == "Update")
        {
          ...
          fetch('https://backend-55jj.onrender.com/update_quote_invoice', { 
            method: 'POST', 
            headers: {   'Accept': 'application/json',
              'Content-Type': 'application/json'  }, 
