...
class InvoiceItems(db.Model):
    ...
    item_invoice =db.Column(db.Integer,db.ForeignKey('tbl_invoice.id'))
    item_name_name = db.relationship('TblProduct', backref='InvoiceItems.item_product')
    item_invoice_name = db.relationship('TblInvoice', backref='InvoiceItems.item_invoice')    
    ...
    def __init__(self,id,item_name, item_product,item_invoice,item_name_name,item_invoice_name,item_qnty,item_rate,item_per_tax,item_tax,item_disc,item_amount,item_description,datetime,item_disc_val, userid):
        ...
        self.item_name_name = InvoiceItems.item_product.product_name
        self.item_invoice_name = InvoiceItems.item_invoice.invoice_num
