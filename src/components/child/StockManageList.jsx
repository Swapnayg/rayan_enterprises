...
const StockManageList = () => {
  ...
  function refreshtable()
  {
    ...
    fetch('https://backend-55jj.onrender.com/inv_stock_data'+'/'+localStorage.getItem('id')).then((res) =>
  ...
  useEffect(() => {
    ...
    $(document).off('click', '.stock_edit').on("click", '.stock_edit', function(e){
      ...
      setedithidden(false);
        ...
        var row_id = $(this).attr("data-lable");
        fetch('https://backend-55jj.onrender.com/get_stk_return_data', { 
          method: 'POST', 
      ...
      $(document).off('click', '.stock_delete').on("click", '.stock_delete', function(e){
        ...
        var row_type = $(this).attr("data-type");
        setId(row_id);
        fetch('https://backend-55jj.onrender.com/invoice_stock_delete/'+row_id+'/'+row_type+'/'+localStorage.getItem('id'), { 
          method: 'DELETE', 
  ...
  const handleSubmit = (e) => {
    ...
    if(canSubmit)
    {
      if($("#btnordersubmit").text().trim() == "Update")
      {
        ...
        fetch('https://backend-55jj.onrender.com/update_stk_return_values', { 
          method: 'POST', 
          headers: {   'Accept': 'application/json',
            'Content-Type': 'application/json'  }, 
