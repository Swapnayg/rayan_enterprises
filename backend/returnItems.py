...
class ReturnItems(db.Model):
    ...
    item_invoice =db.Column(db.Integer,db.ForeignKey('tbl_stock_rtn.id'))
    item_name_name = db.relationship('TblProduct', backref='ReturnItems.item_product')
    item_invoice_name = db.relationship('TblStockRtn', backref='ReturnItems.item_invoice')    
    ...
    def __init__(self,id,item_name, item_product,item_invoice,item_name_name,item_invoice_name,item_qnty,item_rate,item_per_tax,item_tax,item_disc,item_amount,item_description,datetime,item_disc_val,userid):
        ...
        self.item_name_name = ReturnItems.item_product.product_name
        self.item_invoice_name = ReturnItems.item_invoice.stock_num
