...
const ManageInvoiceList = () => {
  ...
  function refreshtable()
  {
    ...
    fetch('https://backend-55jj.onrender.com/inv_invoice_data'+'/'+localStorage.getItem('id')).then((res) =>
  ...
  useEffect(() => {
    ...
    $(document).off('click', '.invoice_edit').on("click", '.invoice_edit', function(e){
      ...
      setedithidden(false);
        ...
        var row_id = $(this).attr("data-lable");
        fetch('https://backend-55jj.onrender.com/get_inv_invoice_data', { 
          method: 'POST', 
    ...
    $(document).off('click', '.invoice_delete').on("click", '.invoice_delete', function(e){
        ...
        var row_id = $(this).attr("data-lable");
        setId(row_id);
        fetch('https://backend-55jj.onrender.com/invoice_inv_delete/'+row_id+'/'+localStorage.getItem('id'), { 
          method: 'DELETE', 
  ...
  const handleSubmit = (e) => {
    ...
    if(canSubmit)
    {
      if($("#btnordersubmit").text().trim() == "Update")
      {
        ...
        fetch('https://backend-55jj.onrender.com/update_invoice_values', { 
          method: 'POST', 
          headers: {   'Accept': 'application/json',
            'Content-Type': 'application/json'  }, 
